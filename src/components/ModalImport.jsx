...
const ModalImport = () => {
    ...
    const { modalImport, handleModalImport, importProject, projectImport } = useProject();

    const handleImport = () => {
        if (Object.entries(projectImport).length === 0)
            return;
    ...
    return (
        <Transition.Root show={modalImport} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleModalImport}>
